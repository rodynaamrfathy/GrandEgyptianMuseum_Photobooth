...
const ShareButton: React.FC<ShareButtonProps> = ({ cardBlob, imageBlob, className }) => {
  ...
  const handleShare = async () => {
    try {
      ...
      // User dismissed the share sheet — not an error, do not alert.
  ...
  return (
    ...
    >
      ...
      <span className="text-white font-medium font-greta-sans">{t("share.button")}</span>
    </button>
  );
};
